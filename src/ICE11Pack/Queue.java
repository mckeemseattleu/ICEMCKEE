...
public class Queue<E> {
    ...
    public Queue<E> copy() {
        ...
        Node current = head;
        while (current != null) {
            newQueue.enqueue(current.payload);
    ...
    /**
     * Reverses the items contained in this queue
     *
     * @return a new queue containing the items of this queue in reverse order
     */
